...
export interface ApiYaronYaron extends Schema.SingleType {
  collectionName: 'yarons';
  info: {
    singularName: 'yaron';
    pluralName: 'yarons';
    displayName: 'yaron';
  ...
  attributes: {
    yaraon: Attribute.String & Attribute.DefaultTo<'asdfasdf'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
